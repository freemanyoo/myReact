...
const NewsList = ({ category }) => {
  ...
  const sendData = () => {
    ...
    if (category === 'busanAtt') {
      return axios.get(
        `https://apis.data.go.kr/6260000/AttractionService/getAttractionKr?serviceKey=PFNk9v9cCKHvbhFAUOLti6ahe6%2Fs7wg39B58uACT8OG%2BMlvtagdSuaAfb2%2BBr3pxs11qSuw1qye09ewA7cByew%3D%3D&numOfRows=100&pageNo=1&resultType=json`,
      );
    } else {
      return axios.get(
